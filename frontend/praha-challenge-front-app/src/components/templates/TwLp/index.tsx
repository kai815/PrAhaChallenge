...
import RecentPostCard, {
  PropsType as RecentPostCardPropsType,
} from '@/components/organisms/Card/Post/Recent';
import AuthorListCard, {
  PropsType as AuthorListCardPropsType,
} from '@/components/organisms/Card/AuthorList';
import CategoryListCard, {
  PropsType as CategoryListCardPropsType,
} from '@/components/organisms/Card/CategoryList';
...
const TwLpTemplate = ({ options, posts, authors, categories, recentPost }: TwLpTemplateType) => {
  return (
    <Layout>
      <Header />
      <LayoutInner>
